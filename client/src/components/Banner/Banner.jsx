                    ...
                    <div className="row flex-sm-row-reverse">
                        <div className="col-md">
                            <div className='position-relative'>
                                ...
                                <div className='d-md-flex justify-content-around align-items-center gap-4 mt_20 __dish__box'>
                                    <div className='dish'>
                                        <div className=' d-flex gap-2 banner__shotimg__container p-2 shadow rounded-3'>
                                            <img src="images/home/b-food1.png" className='rounded img-fluid' height='80' width='80' />
                                            <div className='ms-3'>
                                    ...
                                    <div className='dish'>
                                        <div className='d-md-flex  d-none gap-2 banner__shotimg__container p-2 shadow rounded-3'>
                                            <img src="images/home/b-food1.png" className='rounded img-fluid' height='80' width='80' />
                                            <div className='ms-3'>
                                                <h5 className=' fw-semibold fs-6 mb-1'>Spicy noodles</h5>
                                                <Rating name="read-only" value={3} readOnly className='fs-6' />
                                                <p className=' text-danger pb-0 mb-0 fs-6'>$18.00</p>
                                            </div>
                                        </div>
                                    </div>
